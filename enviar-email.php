...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    <a href="https://www.homehost.com.br/blog/tutoriais/email-marketing/como-importar-listas-de-email-para-o-email-marketing/" >$mail->addReplyTo($email, $nome);  //AQUI SERA O EMAIL PARA</a> O QUAL SERA RESPONDIDO                  
